...
public class MyPacMan extends PacmanController {
    ...
    public enum PlayerState {EAT,ATTACK,WONDER};
    ...
    public MOVE getMove(Game game, long timeDue) {
        ...
        for (Constants.GHOST ghost : Constants.GHOST.values()) {
            ...
            if (game.getGhostEdibleTime(ghost) == 0 && game.getGhostLairTime(ghost) == 0) {
                ...
                if (ghostLocation != -1) {
                    if (game.getShortestPathDistance(current, ghostLocation) < 30) {
            ...
            if((game.wasPacManEaten()||game.getGhostEdibleTime(ghost) > 0 && game.getGhostLairTime(ghost) == 0)) {
...
//                    System.out.println("Hunting Ghost");
                ...
                break;
                case EAT:
                	if(current==91) {actualPlayerState = PlayerState.WONDER; return MOVE.UP;}//this is for fixing a bug
